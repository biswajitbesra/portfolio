...
function MainContainer() {
    return (
        <div className='h-cus-35 w-3/4 backdrop-blur-md rounded-xl absolute top-24 max-[996px]:top-0 max-[996px]:h-full max-[996px]:w-full flex items-center max-[1200px]:w-11/12 max-[667px]:w-full'>
